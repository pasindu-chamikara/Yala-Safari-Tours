...
export default function StaffManagement() {
  ...
  const fetchUsers = async () => {
    setLoading(true);
    const { success, data } = await getUsers(["STAFF", "ADMIN", "SUPER_ADMIN"]);
    if (success && data) {
      setUsers(data);
    }
    setLoading(false);
      ...
      <div className="space-y-6 relative">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-stone-500">Manage internal team members and administrators.</p>
          </div>
                    ...
                    <tr key={user.uid} className="hover:bg-stone-50">
                      ...
                      <td className="px-6 py-4 text-right flex items-center justify-end gap-3">
                        ...
                        >
                          ...
                          {/* Admins can't promote to Admin/SuperAdmin, but can see the options if the user is already one */}
          ...
          <div className="fixed inset-0 bg-stone-900/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-none shadow-2xl w-full max-w-md overflow-hidden">
              <div className="flex justify-between items-center p-6 border-b border-stone-100">
                <h3 className="text-xl font-bold text-stone-800">Create Staff Member</h3>
